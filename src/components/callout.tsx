  ...
  return (
    <div
      className={cn(
        ...
        {
          "text-red-700 bg-red-50 dark:text-red-400 dark:bg-red-600/10 dark:prose": type === "danger",
          "text-yellow-700 bg-yellow-50 dark:text-yellow-400 dark:bg-yellow-600/10 dark:prose": type === "caution",
          "text-blue-700 bg-blue-50 dark:text-blue-400 dark:bg-blue-600/10 dark:prose": type === "info",
          "text-green-700 bg-green-50 dark:text-green-400 dark:bg-green-600/10 dark:prose": type === "tip",
          "text-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-600/10 dark:prose": type === "note",
        }
      )}
      {...props} >
